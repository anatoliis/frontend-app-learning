    ...
    it('returns normalized sequence metadata  ', async () => {
      ...
      const normalizedSequenceMetadata = {
        ...
        units: [{
          ...
          legacyWebUrl: `${getConfig().LMS_BASE_URL}/courses/course-v1:edX+DemoX+Demo_Course/jump_to/block-v1:edX+DemoX+Demo_Course+type@vertical+block@2152d4a4aadc4cb0af5256394a3d1fc7?experience=legacy`,
        }],
      };
      const response = await getSequenceMetadata(courseId, sequenceId);
      expect(response).toBeTruthy();
